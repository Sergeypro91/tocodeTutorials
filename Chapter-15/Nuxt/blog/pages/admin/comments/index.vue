...
export default {
  ...
  methods: {
    loadComments() {
      axios
        .get('https://tocode-blog-nuxt.firebaseio.com/comments.json')
        .then(res => {
          let commentsArray = []
    ...
    changeComment(comment) {
      ...
      axios.put(
        `https://tocode-blog-nuxt.firebaseio.com/comments/${comment.id}.json`,
        comment
      )
    },
    ...
    deleteComment(id) {
      axios
        .delete(`https://tocode-blog-nuxt.firebaseio.com/comments/${id}.json`)
        .then(res => {
          this.loadComments()
        })
    }
